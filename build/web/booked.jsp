<%-- 
    Document   : booked
    Created on : Mar 17, 2022, 6:52:44 PM
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <%                                       
                                            ...
                                            String query = "select * from booking join users on booking.u_id = users.id join sedan on booking.s_id = sedan.s_id where booking.b_status = 1";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="checkoutbutton.jsp?id=<%=rs.getInt("b_id")%>"><button type="submit" class="btn btn-success">Check Out</button></a>
