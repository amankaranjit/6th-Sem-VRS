...
//                                        System.out.println(id);
                                        ...
                                        <div class="col">
                                            <h5 class="text-left ">
                                                <p class="py-4">Dear. <%= uname%>, your pick up date is <%= pickup_date%>,
                                                    drop date of the vehicle is <%= drop_date%>, total number of days for the reservation
                                                    is (<%= no_of_days%>) days and your total cost is Rs.<%= price%> only.</p>
                                            </h5>
                                            <!--<h5 >Do you want a guide?  <a href="GuidePage.jsp" class="text-dark">Yes</a> ||  <a href="checkoutpage.jsp" class="text-dark" >No</a></h5>-->
                                ...
                                <button class="btn text-light mb-2 mt-2" style="background-color:darkblue; border-radius: 30px; width: 93%; margin-left: 22px; height: 55px;"><a href="index.jsp" class="text-light"> Don't Want to Pay Now</a></button>                                          
                            </div>
                        </div>
                    </div>
