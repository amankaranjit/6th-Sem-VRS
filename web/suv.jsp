    ...
    <body>
        <main role="main">
            <div class="album py-5 ">
                <div class="container">
                    <h2 class="text-center p-3 text-secondary">SUV We Have</h2>
                    ...
                    <div class="row">   
                        <%
                            ...
                            ResultSet rs = stmtt.executeQuery("select * from sedan join category where sedan.c_id = category.id and  category.name = 'suv'" );
                            while (rs.next()) {
