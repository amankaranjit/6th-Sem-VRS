    ...
    <body>
        <main role="main">
            <div class="album py-5 ">
                <div class="container">
                    <h2 class="text-center p-3 text-secondary">Pick up We Have</h2>
                    ...
                    <div class="row">   
                        <%
                            ...
                            ResultSet rs = stmtt.executeQuery("select * from sedan join category where sedan.c_id = category.id and  category.name = 'pick up'" );
                            while (rs.next()) {
                            ...
                            <div class="card mb-4  text-secondary  ">
                                ...
                                <div class="card-body px-3 py-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary mt-2"><a style="font-size:15px;" href="login.jsp" class="text-decoration-none text-secondary">Rent Now</a></button>
                                        </div>
                                    </div>
                                    <%} else {%>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary mt-2"><a style="font-size:15px;" href="BookNow.jsp?id=<%= s_id%>" class="text-decoration-none text-secondary">Rent Now</a></button>
                                        </div>
                                    </div>
                                    <%}%>
                                    <%} else {%>
