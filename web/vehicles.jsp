    ...
    <body>
        ...
        <main role="main">
            <div class="album py-5 ">
                <div class="container">
                    <h2 class="text-center p-3 text-secondary text-capitalize">Vehicles Avaliable</h2>
                    ...
                    <div class="row">   
                        <%
                            ...
                            ResultSet rs = stmt.executeQuery("select * from sedan join category where sedan.c_id = category.id and s_status = 0" );
                            while (rs.next()) {
                        ...
                        <div class="col-md-4 ">
                            <div class="card mb-4  text-secondary  ">
                                <!--<img src="" alt=""/>-->
                                <img class="card-img-top"  src="<%= Simage%>" height="200px" width="220px" alt="Card image cap">
                                <div class="card-body px-3 py-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary text-light mt-2"><a style="font-size:15px;" href="BookNow.jsp?id=<%= s_id%>" class="text-decoration-none text-secondary">Rent Now</a></button>
                                        </div>
                                    </div>
        ...
        -->
        <jsp:include page="suv.jsp"/>
        <jsp:include page="sedan.jsp"/>
        <jsp:include page="picup.jsp"/>
